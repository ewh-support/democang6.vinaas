...
function resetGalleryListSize_default(settings){
	var cfg = $.extend({wrap:null,listwrap:null,limitimg_size:{w:160,h:120},default_limit:4,wsize_limits:[[480,2]],li_height_more:50,sel_thumb:"img"},settings);
	var $wrap = cfg.wrap;
	var $listWrap = cfg.listwrap ;
	var items = $("li",$listWrap);
	
	var f_width = $wrap.width();
	var orgImgSize = cfg.limitimg_size;//{w:175,h:122};
